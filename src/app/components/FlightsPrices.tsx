    ...
    <section className="flex flex-col justify-center items-center mt-20 text-center px-14">
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6 mt-12 w-full`}>
        {packages.map((pkg, index) => (
          <div key={index} className="p-4 border text-center shadow-md flex flex-col justify-between relative bg-white rounded-lg overflow-hidden hover:scale-105 transform transition-transform duration-300 cursor-pointer">
            <div
            ...
            <div className="pt-10"> {/* Increased padding to avoid badge overlap */}
              ...
              <a
                ...
                className="bg-[#3399cc] text-white py-2 px-4 rounded-2xl hover:bg-[#2e8ab8] transition duration-300 font-montserrat"
                target="_blank"
